"""The adapter-agnostic session runtime: bound an actor session, run it over either transport, and
...
interpret a run; `prompt.py` is what the actor is told. Nothing here names a concrete adapter — the
