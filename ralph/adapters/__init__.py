...
The agent-agnostic session runtime lives in `runtime/` — two transport spines (subprocess and SDK
turn-stream) under two role cores (Implementer and Editor), all bounded on the wall clock. Concrete
agents build on it: Codex and Copilot each fill both roles over one SDK session; Claude Code fills
